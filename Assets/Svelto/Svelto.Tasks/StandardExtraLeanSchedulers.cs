...
namespace Svelto.Tasks.ExtraLean
{
    public static class StandardSchedulers
    {
        ...
        static Unity.RenderMonoRunner<IEnumerator>      _renderScheduler;
        ...
        public static Unity.RenderMonoRunner<IEnumerator> renderScheduler => _renderScheduler ??
                                                                             (_renderScheduler = new Unity.RenderMonoRunner<IEnumerator>("StandardRenderRunner"));
